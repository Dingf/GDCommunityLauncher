...
constexpr char EAPI_NAME_LOCALIZE_WITHOUT_PARAMS[] = "?LocalizeWithoutParams@LocalizationManager@GAME@@QEAAPEBGPEBD@Z";
...
constexpr char EAPI_NAME_LOCALIZE_WITHOUT_PARAMS[] = "?LocalizeWithoutParams@LocalizationManager@GAME@@QAEPBGPBD@Z";
