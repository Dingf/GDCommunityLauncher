...
constexpr char GAPI_NAME_USE_ITEM_ENCHANTMENT[] = "?UseOn@ItemEnchantment@GAME@@UEAA_NPEAVEntity@2@_NAEA_NIW4ItemSource@2@@Z";
...
constexpr char GAPI_NAME_USE_ITEM_ENCHANTMENT[] = "?UseOn@ItemEnchantment@GAME@@UAE_NPAVEntity@2@_NAA_NIW4ItemSource@2@@Z";
